...
_IMAGENET_CLASS_TO_INDEX = {c: i for i, c in enumerate(sorted(os.listdir('/datasets/imagenet/train')))}
...
class ImageNetDetection(torchvision.datasets.VisionDataset):
    ...
    This class extends :class:`torchvision.datasets.VisionDataset`.
    Its constructor supports the following additional arguments:
