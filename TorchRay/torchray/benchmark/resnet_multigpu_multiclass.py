...
class ResNet(nn.Module):
    ...
    def _forward(self, images, composite_images=None, targets=None, gcam_gt_targets=None, gt_quadrants=None,
        ...
        orig_gradcam_mask = self.compute_gradcam(images_outputs, images_feats, gcam_gt_targets)
        ...
        composite_gradcam_mask = self.compute_gradcam(composite_images_outputs, composite_images_feats, gcam_gt_targets)
